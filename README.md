...
2. Сгенерирует криптографически стойкий ключ шифрования.
3. Развернет изолированный контейнер с ботом.

От вас потребуется только указать `BOT_TOKEN` (полученный у @BotFather) и свой `USER_ID`.
