...
Быстрый запуск с автоматическим созданием базы PostgreSQL и генерацией ключа шифрования.
...
3. Дождитесь окончания сборки и настройте [UptimeRobot](#настройка-пинга-uptimerobot) для предотвращения засыпания.
