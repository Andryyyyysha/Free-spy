...
BOT_VERSION = "1.3.0"
CHANGELOG_TEXT = (
    "📢 <b>Обновление бота (v1.3.0):</b>\n\n"
    "• <b>Сохранение медиа по реплаю:</b> Ответьте точкой (<code>.</code>) на любое пересланное ботом сообщение, и он пришлет вам сохраненную копию медиафайла.\n"
    "• <b>Настройка автоудаления точки:</b> В меню <b>⚙️ Настройки</b> добавлен тумблер для автоматического удаления точки-триггера после пересылки файла.\n"
    "• <b>Уведомления о подключении:</b> Добавлены сервисные оповещения при успешной привязке или отключении бота.\n\n"
    "⚙️ <i>Отправьте команду /start, чтобы обновить меню и применить новые настройки!</i>"
)
