...
CHANGELOG_TEXT = (
    ...
    "• Добавлено меню <b>⚙️ Настройки</b>, в котором можно включить или выключить оповещения об обновлениях и перезапусках бота.\n"
    "• Добавлена кнопка <b>🛡️ Безопасность и хостинг</b>, подробно описывающая сквозное шифрование AES-128 ваших сообщений и инструкцию по установке собственного сервера."
)
